//
//  MCLFetchedResultsMapViewController.m
//  MCoreLocation
//
...
#import "MCLFetchedResultsMapViewController.h"
#import "NSPredicate+MCL.h"

NSString* kDefaultAnnotationViewIdentifier = @"Pin";

@interface MCLFetchedResultsMapViewController()
...
@implementation MCLFetchedResultsMapViewController
...
-(MKAnnotationView *)mapView:(MKMapView *)mapView viewForAnnotation:(id<MKAnnotation>)annotation{
    ...
    if(!view){
        ...
        UIImage *image = [[UIImage imageNamed:@"DisclosureArrow" inBundle:[NSBundle bundleForClass:MCLFetchedResultsMapViewController.class] compatibleWithTraitCollection:nil] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
