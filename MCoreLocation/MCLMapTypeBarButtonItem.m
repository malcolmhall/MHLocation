...
static void * const kMCLMapTypeBarButtonItemContext = (void *)&kMCLMapTypeBarButtonItemContext;

@interface MCLMapTypeBarButtonItem()

@property (nonatomic, assign) BOOL ignoreChange;

@end

@implementation MCLMapTypeBarButtonItem
...
- (id)initWithMapView:(MKMapView *)mapView{
    ...
    if (self) {
        ...
        [mapView addObserver:self forKeyPath:NSStringFromSelector(@selector(mapType))
                     ...
                     context:kMCLMapTypeBarButtonItemContext];
                       ...
                       context:(void *)context
{
    ...
    if(context == kMCLMapTypeBarButtonItemContext){
