...
@property (nonatomic, strong) MCLMapTypeBarButtonItem *item;
@end
...
- (void)viewDidLoad {
    ...
    MCLMapTypeBarButtonItem *item = [[MCLMapTypeBarButtonItem alloc] initWithMapView:self.mapView];
    item.target = self;
    ...
    self.annotationsTablePresentationStyle = MCLAnnotationsTablePresentationStyleSheet;
}
